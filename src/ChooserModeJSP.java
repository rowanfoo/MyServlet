	  ...
	  throws ServletException, IOException
		{
		 ...
		 String nextJSP = "/ChooserModeJSP.jsp";
			 ...
			 date = (String)request.getAttribute("MyModeDate");
...
public void doPost(HttpServletRequest request,
  ...
  throws ServletException, IOException
	{
	 System.out.println("DO doPost   :ChooserModeJSP");
			...
			if(MyModeDate ==null ){
				int  index = Integer.parseInt( request.getParameter("combo1").trim());
				 System.out.println("ChooserModeJSP DO Post  :"+ index);
			
				 ArrayList <TechStrAccess>  myarr ;
				try(DAOFactoryTechStr dao = new DAOFactoryTechStr()) {
					
					//ArrayList <TechStrAccess>  myarr = dao.getTechStrList(null,date);
					 System.out.println("DO Post find  :");
				...
				if(arr.size()==0 ){// if no result found 
				...
				request.setAttribute("MyModeDate",MyModeDate  );

...
public class TechStrDAO extends DAO {
	...
	public ArrayList <TechStrAccess>   getTechStrListByMonthMode(int  month)throws Exception{
		...
		String mysql="";
		mysql ="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and Month(techstr.date)=? and mode in(8,10,12,18)";	
	...
	public ArrayList <TechStrAccess>   getTechStrListBySql(String sql,int mode)throws Exception{
		...
		if (mode==0){
		mysql="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,top,lowlow,sixMonthPrice,twohundredchg,open "+
			 "FROM fortune.techstr join stock on stock.code= techstr.code "+  
			 " where top in('50','100','200','300','top0.5b','top1b') and "+sql;
		}else{
			mysql="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,top,lowlow,sixMonthPrice,twohundredchg,open  "+
					 "FROM fortune.techstr join stock on stock.code= techstr.code "+  
					 " where top in('50','100','200','300','top0.5b','top1b') and techstr.mode=? and "+sql;
	...
	private TechStrAccess getTechStrAccess(ResultSet rs)throws Exception {
		return   new TechStrAccess (rs.getString("code"),rs.getDate("date"),rs.getString("name"),rs.getInt("mode") ,rs.getDouble("close"),rs.getDouble("fifty"),rs.getDouble("fiftychg"),rs.getLong("volume") ,rs.getDouble("3mthVol")  ,rs.getDouble("changePercent"),
	...
	public ArrayList <TechStrAccess>   getTechStrListByDate(String code,String date)throws Exception{
		ArrayList <TechStrAccess> arr = new ArrayList();
		String mysql="";
		if(code == null)mysql ="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and techstr.date=?"  ; 
		else mysql ="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and techstr.date=? and techstr.code=? "  ; 
	...
	public ArrayList <TechStrAccess>   getTechStrListByWeek(int weekno)throws Exception{
		...
		String mysql = "";
		mysql = "SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and "
				+ "week(techstr.date) = ? group by mode,code";
	...
	public ArrayList <TechStrAccess>   getTechStrListByMonth(int month)throws Exception{
		...
		String mysql = "";
		mysql = "SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and "
				+ "month(techstr.date) = ? group by mode,code";
	...
	public ArrayList <TechStrAccess>   getTechStrListByDate(String code,String date,int mode)throws Exception{
		ArrayList <TechStrAccess> arr = new ArrayList();
		String mysql="";
		if(code == null)mysql ="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and techstr.date=? and mode=?"  ; 
		else mysql ="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and techstr.date=? and techstr.code=? and mode=? "  ; 
	...
	public ArrayList <TechStrAccess>   getTechStrListByTop300ByDate(String mode,  String date)throws Exception{
		...
		if(mode.equals("Top 100-300")){
			mysql="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,top,lowlow,sixMonthPrice,twohundredchg,open "+
			 "FROM fortune.techstr join stock on stock.code= techstr.code "+  
			 " where top in('50','100','200','300','top0.5b','top1b') and techstr.date=?";
		}else if(mode.equals("Top Others")){	
		
			mysql="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,top,lowlow,sixMonthPrice,twohundredchg,open "+
				  "FROM fortune.techstr join stock on stock.code= techstr.code "+  
				  " where top not in('50','100','200','300','top0.5b','top1b') and techstr.date=?";
	...
	public ArrayList <TechStrAccess>   getTechStrListByPanic()throws Exception{
		...
		String mysql="";
			mysql="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,top,lowlow,sixMonthPrice,twohundredchg,open "+
					" FROM fortune.techstr join stock on stock.code= techstr.code "+ 
					 " where mode in (2,3,5,6,9,13,14,20,21,23,24,27,28,29) and techstr.date=curdate()";
	...
	public ArrayList <TechStrAccess>   getTechStrListByMode(int mode)throws Exception{
		ArrayList <TechStrAccess> arr = new ArrayList();
		String mysql="SELECT techstr.code,techstr.date,mode,name,close,fifty,fiftychg,volume,3mthVol,changePercent,seen,OK,Notes,fiftycount,lowlow,sixMonthPrice,twohundredchg,open FROM fortune.techstr join stock on stock.code= techstr.code and mode=?"  ; 
	...
	public void deleteThisMonthTechStrListByMonthMode() throws Exception {
		String mysql = "delete from techstr where  Month(techstr.date)=? and mode in(8,10,12,18)";
	...
	public void deleteTodayDate()throws Exception {
		...
		String mysql="delete from techstr where date=curdate()";
